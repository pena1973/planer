...
import { OperStatusEnum } from '@/pages/db/models/enums';
...
export class TCardOperationTable {
  ...
  @Column({
    type: 'enum',
    enum: OperStatusEnum,      // Используем enum для ограничения значений
    default: OperStatusEnum.D,  // Устанавливаем значение по умолчанию
  })
